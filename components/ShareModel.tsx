...
import { updateDocumentAccess } from '@/lib/action/room.action';


const ShareModel = ({ currentUserType, creatorId, collaborators, roomId }: ShareDocumentDialogProps) => {
